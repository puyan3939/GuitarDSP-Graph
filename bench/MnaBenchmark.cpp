...
// PreampCircuit -> PowerAmpCircuit cascade (see FullAmpCircuit.h). Reports
// each stage's own engine stats since the two stages are independent
// MnaCircuitEngine instances, not one combined solve.
